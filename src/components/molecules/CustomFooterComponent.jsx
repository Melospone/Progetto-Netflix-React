        ...
        <>
            <div>
                <div className="nav-item mx-4">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="currentColor"
                        class="bi bi-instagram text-secondary me-4" viewBox="0 0 16 16">
                        <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="currentColor"
                        class="bi bi-twitter text-secondary me-4" viewBox="0 0 16 16">
                        <path
                ...
                <div className="nav-item mx-4 my-2">
                    <li class="nav-item">
                        <a class="nav-link text-secondary">Audio and Subtitles</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-secondary">Media Center</a>
                    </li>
                    <li class="nav-item">
